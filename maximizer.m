function [ superaggregatetemp, max_matrix ] = maximizer ( Lagg, Ragg )
...
superaggregatetemp = [Lagg Ragg];

for sess = 1:num_sess
    maxtempmatrix(sess,:) = max(superaggregatetemp(sess).mean_collapsed_EMGs);
end
